...
const Sidebar = () => {
  ...
  const submitResults = async () => {
    ...
    try {
      ...
      toast('Submitting your results...');

      const resp = await axios.post(`${API_BASE}/api/results`, payload, {
        headers: {
      ...
      if (resp.data && resp.data.success) {
        ...
        toast.warn('Could not submit results. Please try again later.');
        submittedRef.current = false;
      }
    }
    catch (err) {
              ...
              <div className={sidebarStyles.logoContainer}>
                ...
                <div>
                  ...
                  <p className={sidebarStyles.logoSubtitle}>
                    Test your skills across various technologies!
                  </p>
                </div>
              </div>
